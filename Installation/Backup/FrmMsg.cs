...
namespace Installation
{
    public partial class FrmMsg : Form
    {
        ...
        {
            lblClose.Image = Installation.Properties.Resources.MSGClose_Ent;
        }

        private void lblClose_MouseDown(object sender, MouseEventArgs e)
        {
            lblClose.Image = Installation.Properties.Resources.MSGClose_Dwn;
            lblClose.Location = new Point(lblClose.Location.X + 1, lblClose.Location.Y + 1);
        }

        private void lblClose_MouseLeave(object sender, EventArgs e)
        {
            lblClose.Image = Installation.Properties.Resources.MSGClose_Nor;
        }
        ...
        {
            lblCancel.Image = Installation.Properties.Resources.btn2_Ent;
        }

        private void lblCancel_MouseLeave(object sender, EventArgs e)
        {
            lblCancel.Image = Installation.Properties.Resources.btn2_Nor;
        }

        private void lblCancel_MouseDown(object sender, MouseEventArgs e)
        {
            lblCancel.Image = Installation.Properties.Resources.btn2_Dwn;
